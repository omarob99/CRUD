 ...
 */
final class Version20220303065434 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE student ADD target_id INT DEFAULT NULL, ADD studentsgrades LONGTEXT NOT NULL, CHANGE id id INT AUTO_INCREMENT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE student DROP target_id, DROP studentsgrades, CHANGE id id INT NOT NULL');
